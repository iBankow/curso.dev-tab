...
describe("PATCH /api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    test("With unique 'username'", async () => {
      ...
      expect(responseBody).toEqual({
        action: "Verifique se seu usuario possui as feature update:user.",
  ...
  describe("Default user", () => {
    ...
    test("With `user2` target 'user1'", async () => {
      await orchestrator.createUser({
      ...
      expect(responseBody).toEqual({
        name: "ForbiddenError",
        message: "Você não tem permissão para outro usuário.",
        action:
          "Verifique você possui a feature necessária para atualizar outro usuário.",
        status_code: 403,
      });
    });
